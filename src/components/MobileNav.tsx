  ...
  if (!isOpen)
    return (
      <button
        ...
        className="lg:hidden relative -m-2 inline-flex items-center justify-center rounded-md p-2 text-secondary-400"
      >
  ...
  return (
    <div className="mobile nav">
      ...
      <div className="fixed overflow-y-scroll overscroll-y-none inset-0 z-40 flex justify-end">
        <div className="w-4/5">
          <div className="relative flex w-full max-w-sm flex-col overflow-y-auto bg-primary pb-12 shadow-xl">
